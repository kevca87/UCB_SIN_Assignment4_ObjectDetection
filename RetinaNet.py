...
def compute_iou(boxes1, boxes2):
    ...
    lu = tf.maximum(boxes1_corners[:, None, :2], boxes2_corners[:, :2])# left-upper corner
    rd = tf.minimum(boxes1_corners[:, None, 2:], boxes2_corners[:, 2:])# right-down corner
